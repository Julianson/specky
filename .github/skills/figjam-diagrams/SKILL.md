...
description: "Creates professional FigJam diagrams using the Figma MCP connector with Mermaid syntax, Microsoft brand colors, and proven rendering patterns. Activates when the user asks to create any diagram, flowchart, sequence diagram, architecture diagram, process flow, or visual in FigJam/Figma — including agent flows, SDLC diagrams, handoff maps, deployment diagrams, triggers/events, guardrails, and any technical or business diagrams. Also triggers when the user mentions diagrama, fluxo, FigJam, Figma diagram, mermaid diagram, or wants to visualize any process, architecture, or system interaction. Encodes hard-won lessons about FigJam Mermaid renderer quirks and provides Microsoft-branded color palettes that render correctly every time."
---
...
```json
{
  "mermaidSyntax": "<your mermaid code>",
  "userIntent": "<description of what the diagram shows>"
}
```
