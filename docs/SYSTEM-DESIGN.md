...
C4Context
  ...
  System(specky, "Specky MCP Server", "56 tools for Spec-Driven Development")
...
flowchart TB
  ...
  subgraph "Tool Layer (56 tools, 15 registration files)"
  ...
  subgraph "Service Layer (26 services)"
    FM["FileManager"]
    SM["StateMachine"]
    TE["TemplateEngine"]
    EV["EarsValidator"]
...
| **Input Injection** | Zod .strict() schemas | All 56 tools validate input, reject unknown fields |
...
- Consistent UX across all 56 tools
...
**Date:** 2026-03-27
**Tools used:** 56 MCP tools, 17 diagram types, 12-section design template
